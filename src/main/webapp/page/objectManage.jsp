...
<body>
		...
		<div id="mainPanel">
			...
			<div id="dataGridCan">
			            ...
			            <table style="width:100%;">
			                <tr>
			                    ...
			                    <td style="white-space:nowrap;">
			                       <!-- <input id="key" class="mini-textbox" emptyText="请输入验证对象类型名称" 
			    ...
			    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:92%;min-height:359px;" 
			    	url="../commonParam.do?type=findCommonParamByType&paramType=VERIFY_TYPE" pageSize="20" allowCellEdit="false" allowCellSelect="true" 
			        ...
			        <div property="columns">
			            ...
			            <div field="name" width="300" headerAlign="center" allowSort="false">验证对象类型名称
	...
	<script type="text/javascript" src="../resource/script/objectManage.js"></script>
</body>
</html>