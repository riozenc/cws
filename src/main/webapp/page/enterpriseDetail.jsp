			...
			<div id="dataGridCan">
			    ...
			    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:216px;" 
			        ...
			        <div property="columns">          
			            ...
			            <div type="comboboxcolumn" name="job" field="job" width="100" headerAlign="center" autoShowPopup="true">
							职务
					...
					<div id="dataGridCan">
					    ...
					    <div id="datagrid2" class="mini-datagrid" style="width:100%;height:218px;" 
					        ...
					        <div property="columns">          
					            ...
					            <div type="comboboxcolumn" name="duty" field="duty" width="150" headerAlign="center" 
