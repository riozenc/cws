			...
			<div id="dataGridCanMaster">
			    ...
			    <div id="datagridMaster" class="mini-datagrid" style="width:100%;height:81%;min-height:148px;" 
			        ...
			        <div property="columns">
			            ...
			            <div field="model" headerAlign="center" allowSort="false" width="100">型号
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            </div>
			            <div field="SN" headerAlign="center" allowSort="false" width="100" align="center">SN号
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            </div>
			            <div name="addDate" field="addDate" width="100" allowSort="true" dateFormat="yyyy-MM-dd" 
			...
			<div id="dataGridCanPoint">
			    ...
			    <div id="datagridPoint" class="mini-datagrid" style="width:100%;height:83%;min-height:148px;" 
			    	url="../resource/data/point.txt" pageSize="20" allowCellEdit="false" allowCellSelect="true" 
			    		multiSelect="false" idField="id">
			        <div property="columns">
			        	<div field="number" headerAlign="center" allowSort="false" width="80">编号
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            </div>
			            <div field="SN" headerAlign="center" allowSort="false" width="100" align="center">SN号
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            ...
			            <div field="verifyUnit" headerAlign="center" allowSort="false" width="120">校验单位
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            </div>
			            <div field="paperNo" headerAlign="center" align="center" allowSort="false" width="100">证书编号
			                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="80" />
			            </div>
			            <div name="deadline" field="deadline" width="80" allowSort="true" dateFormat="yyyy-MM-dd" 
