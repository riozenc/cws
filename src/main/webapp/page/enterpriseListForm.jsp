	...
	<form id="form1" method="post">
        ...
        <div style="padding-left:6px;padding-top:10px;">
            <table cellspacing="0" cellpadding="5px">
                ...
                <tr>
                    <td class="colTitle">企业名称：</td>
                    <td class="colData">    
                        <input name="companyName" class="mini-textbox"/>
                    </td>
                </tr>
                <tr>
                    <td class="colTitle">联系人：</td>
                    <td class="colData">    
                        <input name="contacts" class="mini-textbox" />
                    </td>
                </tr>
                <tr>
                    <td class="colTitle">电话：</td>
                    <td class="colData">    
                        <input name="telephone" class="mini-textbox" />
                    </td>
                </tr>
                <tr>
