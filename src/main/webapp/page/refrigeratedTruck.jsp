...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../resource/css/refrigeratedTruck.css">
...
<body>
								...
								<form id="baseInfoForm" method="post">
										...
										<td class="baseInfo_cellValue" colspan="3">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="plateNumber" />
												</span>
											</span>
										</td>
									</tr>
									<tr>
										...
										<td class="baseInfo_cellValue" colspan="3">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="spec" />
												</span>
											</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="baseInfo_cellValue" colspan="3">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="fan" />
												</span>
											</span>
										</td>
									</tr>
									<tr>
										...
										<td class="baseInfo_cellValue_d">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="passageway" />
												</span>
											</span>
										</td>
					            ...
					            <table style="width:100%;">
					                <tr>
					                    ...
					                    <td style="white-space:nowrap;">
					                    	<input id="schemeType" name="schemeType" class="mini-combobox" showNullItem="false" 
	...
	<script type="text/javascript" src="../resource/script/refrigeratedTruck.js"></script>
</body>
</html>