								...
								<form id="baseInfoForm" method="post">
									...
									<tr>
										...
										<td class="baseInfo_cellValue">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="mainFan" />
												</span>
											</span>
										</td>
										...
										<td class="baseInfo_cellValue">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="prepareFan" />
												</span>
											</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="baseInfo_cellValue" colspan="5">
											<span class="baseInfoSpan1">
												<span class="baseInfoSpan2">
													<input class="baseInfoInput" type="text" name="storageRack" />
												</span>
											</span>
										</td>
									</tr>
